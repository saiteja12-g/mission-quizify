...
if __name__ == "__main__":
    ...
    with screen.container():
        ...
        with st.form("Load Data to Chroma"):
            ...
            topic_input = st.text_input('Topic for Generative Quiz',label_visibility="visible"
                                        ,disabled=False, placeholder="Enter the topic of the document")

            questions = st.slider('Number of Questions ',1,100)
            document = None
